...
def plot_pose(ax, pose: SE2Pose, marker_size = 40, color='red',**kwargs):
...
def plot_point(ax, point: Point2, marker_size = 40, color='blue', label:str = None, label_offset = (3,3),**kwargs):
    marker = "*"
    x, y = point.x, point.y
